...
export default function Home({ integrations }) {
  ...
  return (
    <div>
      <Head>
        <title>Integrations | Lexington</title>
              ...
              <div className="flex">
                ...
                <div className="py-5 sm:p-6">
                  ...
                  <div className="mt-2 text-sm text-gray-500">
                    <p>
                      You currently do not have any integrations set up. Add
                      your first integration to get started.
                    </p>
                  </div>
                      ...
                      .map((integration) => (
                        <li key={integration.type} className="flex py-4">
                          ...
                          <div className="w-2/12 text-right pt-2">
                            <button
                              onClick={() =>
                                integrationHandler(integration.type)
                              }
                              className="font-medium text-blue-600 hover:text-blue-500"
                            >
                              Add
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-2 max-w-xl text-sm text-gray-500">
              <p>
                Select which calendars are checked for availability to prevent
                double bookings.
              </p>
            </div>
            <div className="mt-5">
  ...
  const integrations = [
    {
      ...
      credential:
        credentials.find(
          (integration) => integration.type === "google_calendar"
        ) || null,
    ...
    {
      installed: !!(
        process.env.MS_GRAPH_CLIENT_ID && process.env.MS_GRAPH_CLIENT_SECRET
      ),
      type: "office365_calendar",
      credential:
        credentials.find(
          (integration) => integration.type === "office365_calendar"
        ) || null,
    ...
    },
    {
      ...
      type: "zoom_video",
      credential:
        credentials.find((integration) => integration.type === "zoom_video") ||
        null,
      title: "Zoom",
