...
export default function Home(props) {
  ...
  const stats = [
    ...
    { name: "Integrations", stat: props.integrationCount },
    {
      ...
      stat:
        Math.round(((props.user.endTime - props.user.startTime) / 60) * 100) /
          100 +
        " hours"
    }
  ];
    ...
    timeline = [
      {
        ...
        iconBackground:
          props.integrationCount != 0 ? "bg-green-400" : "bg-gray-400"
      },
      {
        id: 2,
        ...
        iconBackground:
          props.eventTypeCount != 0 ? "bg-green-400" : "bg-gray-400"
      },
      {
        id: 3,
              ...
              <dl className="grid grid-cols-1 overflow-hidden divide-y divide-gray-200 dark:divide-gray-900 md:grid-cols-3 md:divide-y-0 md:divide-x">
                {stats.map((item) => (
                  <div key={item.name} className="px-4 py-5 sm:p-6">
                    <dt className="text-base font-normal dark:text-white text-gray-900">
                      {item.name}
                    </dt>
                  ...
                  <li key={type.id} className="flex">
                      ...
                      <div className="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                        <div className="truncate">
                          <div className="flex text-sm">
                            <p className="flex-shrink-0 font-medium text-blue-600 truncate">
                              {type.title}
                            </p>
                    ...
                    <div className="ml-5 w-1/3 text-right pt-5 pr-4">
                      <Link href={"/availability/event/" + type.id}>
                        <a className="text-gray-400 hover:text-gray-900 mr-4 font-medium">
                          Edit
                        </a>
                      </Link>
                      <Link
